...
![Old UI Design](assets/old_design.png)
*(Note: Please upload your screenshot of the original website as `assets/old_design.png`)*
...
![New UI Design](assets/new_design.png)
*(Note: Please upload the screenshot of the new redesigned website as `assets/new_design.png`)*
